...
class Employee(models.Model):
    ...
    staffIdIfAutogenerated = models.CharField(max_length=100, blank=True, null=True, default='N/A')
...
class EmployeeAttendance(models.Model):
    ...
    inLocation = models.TextField(max_length=1500, blank=True, null=True, default='N/A')
    outLocation = models.TextField(max_length=1500, blank=True, null=True, default='N/A')
